...
<tr>
	<td class='mbLBL'>{sugar_translate module="DynamicFields" label="RANGE_MIN_VALUE"}:</td>
	<td>
	{if $hideLevel < 5}
		<input type='text' name='range_min' id='int_range_min' value='{$vardef.range_min}'>
		<script>addToValidate('popup_form', 'range_min', 'int', false,'{sugar_translate module="DynamicFields" label="RANGE_MIN_VALUE"}' );</script>
	{else}
		<input type='hidden' name='range_min' id='int_range_min' value='{$vardef.range_min}'>{$vardef.range_min}
	{/if}
	</td>
</tr>
<tr>
	<td class='mbLBL'>{sugar_translate module="DynamicFields" label="RANGE_MAX_VALUE"}:</td>
	<td>
	{if $hideLevel < 5}
		<input type='text' name='range_max' id='int_range_max' value='{$vardef.range_max}'>
		<script>addToValidate('popup_form', 'range_max', 'int', false,'{sugar_translate module="DynamicFields" label="RANGE_MAX_VALUE"}' );</script>
	{else}
		<input type='hidden' name='range_max' id='int_range_max' value='{$vardef.range_max}'>{$vardef.range_max}
	{/if}
	</td>
</tr>
<tr>
